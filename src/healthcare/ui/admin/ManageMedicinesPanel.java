...
import healthcare.dao.impl.MedicineDAOImpl;
...
public class ManageMedicinesPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        String[] columns = {"ID", "Medicine Name", "Dosage", "Available"};
        ...
        styleTable(table, new Color(231, 76, 60));

        add(new JScrollPane(table), BorderLayout.CENTER);

        JButton refreshBtn = makeButton("REFRESH", new Color(231, 76, 60));
        JButton addBtn = makeButton("ADD", new Color(46, 204, 113));
        JButton deleteBtn = makeButton("DELETE", new Color(120, 140, 160));
    ...
    private void addMedicine() {
        ...
        dosageField.setFont(new Font("SansSerif", Font.PLAIN, 12));
    ...
    private void deleteMedicine() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            medicineDAO.deleteMedicine((int) tableModel.getValueAt(row, 0));
            loadData();
        }
    }
}