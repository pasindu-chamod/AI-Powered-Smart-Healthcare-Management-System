...
public class ManageDoctorsPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        String[] columns = {"ID", "Name", "Specialization", "Email", "Phone", "License", "Approved"};
        ...
        JButton approveBtn = makeButton("APPROVE", new Color(46, 204, 113));
        refreshBtn.addActionListener(e -> loadData());
        approveBtn.addActionListener(e -> approveDoctor());
    ...
    private void loadData() {
        ...
        for (Doctor d : list) {
            tableModel.addRow(new Object[]{
                ...
                d.getEmail(), d.getPhone(), d.getLicenseNumber(),
                d.isApproved() ? "Yes" : "Pending"
            });
        }
    }
    ...
    private void approveDoctor() {
        ...
        if (row < 0) { JOptionPane.showMessageDialog(this, "Select a doctor!"); return; }
        if (doctorDAO.approveDoctor((int) tableModel.getValueAt(row, 0))) {
            JOptionPane.showMessageDialog(this, "Doctor approved!");
            loadData();
        }
    }
}