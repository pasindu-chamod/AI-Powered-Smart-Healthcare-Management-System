...
public class AllPrescriptionsPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        String[] columns = {"ID", "Patient", "Doctor", "Disease", "Date", "Notes"};
    ...
    private void loadData() {
        ...
        for (Prescription p : list) {
            tableModel.addRow(new Object[]{
                ...
                p.getDiseaseName(), p.getCreatedAt(), p.getDiagnosisNotes()
            });
        }
    }
}