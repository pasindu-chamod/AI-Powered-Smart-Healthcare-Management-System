...
public class LabReportsPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        String[] columns = {"ID", "Type", "Date", "Results", "Status"};
    ...
    private void loadData() {
        ...
        for (LabReport r : list) {
            tableModel.addRow(new Object[]{
                r.getReportId(), r.getReportType(), r.getReportDate(),
                r.getResults(), r.getStatus()
            });
        }
    }
}